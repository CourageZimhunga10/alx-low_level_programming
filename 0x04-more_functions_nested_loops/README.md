...
julien@ubuntu:~/0x04$ 
```
> gcc -Wall -pedantic -Werror -Wextra -std=gnu89 0-main.c 0-isupper.c -o 0-isuper; ./0-isuper 
...
julien@ubuntu:~/0x04$ 
```
> cc -Wall -pedantic -Werror -Wextra -std=gnu89 1-main.c 1-isdigit.c -o 1-isdigit; ./1-isdigit 
...
julien@ubuntu:~/0x04$ 
```
> gcc -Wall -pedantic -Werror -Wextra -std=gnu89 2-main.c 2-mul.c -o 2-mul; ./2-mul 
...
julien@ubuntu:~/0x04$ 
```
> gcc -Wall -pedantic -Werror -Wextra -std=gnu89 _putchar.c 3-main.c 3-print_numbers.c -o 3-print_numbers; ./3-print_numbers | cat -e
...
> gcc -Wall -pedantic -Werror -Wextra -std=gnu89 _putchar.c 4-main.c 4-print_most_numbers.c -o 4-print_most_numbers; ./4-print_most_numbers 
...
julien@ubuntu:~/0x04
```
> gcc -Wall -pedantic -Werror -Wextra -std=gnu89 _putchar.c 5-main.c 5-more_numbers.c -o 5-more_numbers; ./5-more_numbers 
...
julien@ubuntu:~/0x04$ 
```
> gcc -Wall -pedantic -Werror -Wextra -std=gnu89 _putchar.c 6-main.c 6-print_line.c -o 6-lines; ./6-lines | cat -e
...
julien@ubuntu:~/0x04$ 
```
> gcc -Wall -pedantic -Werror -Wextra -std=gnu89 _putchar.c 8-main.c 8-print_square.c -o 8-squares; ./8-squares
...
>  betty 9-fizz_buzz.c; gcc -Wall -pedantic -Werror -Wextra -std=gnu89 9-fizz_buzz.c -o 9-fizz_buzz; ./9-fizz_buzz 
...
> betty 10-print_triangle.c; gcc -Wall -pedantic -Werror -Wextra -std=gnu89 _putchar.c 10-main.c 10-print_triangle.c -o 10-triangles; ./10-triangles
...
> betty 100-prime_factor.c; gcc -Wall -pedantic -Werror -Wextra -std=gnu89 100-prime_factor.c -o 100-prime_factor -lm; ./100-prime_factor
...
julien@ubuntu:~/0x04$ 
```
> betty 101-print_number.c; gcc -Wall -pedantic -Werror -Wextra -std=gnu89 _putchar.c 101-main.c 101-print_number.c -o 101-print_numbers; ./101-print_numbers 
